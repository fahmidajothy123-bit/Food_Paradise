...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-sky-50 pt-16 flex items-center justify-center px-4 page-enter">
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-sm border border-sky-100 p-8">
          ...
          <div className="text-center mb-7">
            ...
            <h1 className="text-2xl font-bold text-gray-800" style={{fontFamily:'Poppins,sans-serif'}}>Welcome Back</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button type="submit" className="w-full btn-primary py-3 text-base mt-1">Login</button>
          </form>
